...
q_1234 = Qs([Q([1, 1, 0, 0]), Q([2, 1, 0, 0]), Q([3, 1, 0, 0]), Q([4, 1, 0, 0])])
sigma_y = Qs([Q([1, 0, 0, 0]), Q([0, -1, 0, 0]), Q([0, 1, 0, 0]), Q([-1, 0, 0, 0])])
qn = Qs([Q([3, 0, 0, 4])])
...
def test__1011_representation_2_txyz():
    ...
    assert equal(
        qr, Q([1.0, -0.9001976297355174, 0.12832006020245673, -0.4161468365471424])
    )
...
def test__1340_product():
    assert equals(
        products(b, o), Qs([Q([10, 0, 0, 0]), Q([20, 0, 0, 0]), Q([30, 0, 0, 0])])
    )
    assert equals(products(b, k), Qs([Q([32, 0, 0, 0])]))
    assert equals(products(products(b, o), k), Qs([Q([320, 0, 0, 0])]))
    assert equals(
        products(b, b), Qs([Q([1, 0, 0, 0]), Q([4, 0, 0, 0]), Q([9, 0, 0, 0])])
    )
    assert equals(
        products(o, k), Qs([Q([40, 0, 0, 0]), Q([50, 0, 0, 0]), Q([60, 0, 0, 0])])
    )
    assert equals(products(o, o), Qs([Q([100, 0, 0, 0])]))
    assert equals(
        products(k, k), Qs([Q([16, 0, 0, 0]), Q([25, 0, 0, 0]), Q([36, 0, 0, 0])])
    )
    assert equals(
        products(k, b),
        Qs(
...
def _test_the_square(
    function_to_test: FunctionType,
    numbers_dict: Dict = None,
    quiet_pass: bool = False,
    ...
    if numbers_dict is None:
        ...
        numbers_dict["real"], numbers_dict["imaginary"] = (
            Q([2.0, 0, 0, 0]),
            Q([0, 3.0, 0, 0]),
        )
        numbers_dict["complex"] = Q([2.0, 4.0, 0, 0])
        numbers_dict["small"], numbers_dict["big"] = (
            Q([0.1, 0.2, 0.3, 0.4]),
            Q([3.0, 4.0, 2.0, 5.0]),
        )
    ...
    print(
        f"testing Cartesian product of these numbers: {', '.join(numbers_dict.keys())}, total={len(numbers_dict.keys()) ** 2}"
    )
...
def test__1501_sins():
    ...
    assert equals(
        sins(Qs([P])), Qs([Q([0, 59.3625684622310033, -44.5219263466732542, 0])])
    )
    assert equals(sins(Qs([R])), Qs([Q([0.1411200080598672, 0, 0, 0])]))
    assert equals(
        sins(Qs([C])), Qs([Q([24.8313058489463785, -11.3566127112181743, 0, 0])])
    )
...
def test__1511_coss():
    ...
    assert equals(
        coss(Qs([C])), Qs([Q([-11.3642347064010600, -24.8146514856341867, 0, 0])])
    )
...
def test__1521_tans():
    ...
    assert equals(
        tans(Qs([P])), Qs([Q([0, 0.7999273634100760, -0.5999455225575570, 0])])
    )
    assert equals(tans(Qs([R])), Qs([Q([-0.1425465430742778, 0, 0, 0])]))
    assert equals(
        tans(Qs([C])), Qs([Q([-0.0005079806234700, 1.0004385132020521, 0, 0])])
    )
...
def test__1531_sinhs():
    ...
    assert equals(
        sinhs(Qs([P])), Qs([Q([0, -0.7671394197305108, 0.5753545647978831, 0])])
    )
    assert equals(sinhs(Qs([R])), Qs([Q([10.0178749274099026, 0, 0, 0])]))
    assert equals(
        sinhs(Qs([C])), Qs([Q([-2.3706741693520015, -2.8472390868488278, 0, 0])])
    )
...
def test__1541_coshs():
    ...
    assert equals(
        coshs(Qs([C])), Qs([Q([-2.4591352139173837, -2.7448170067921538, 0, 0])])
    )
...
def test__1551_tanhs():
    ...
    assert equals(
        tanhs(Qs([P])), Qs([Q([0, -2.7044120049972684, 2.0283090037479505, 0])])
    )
    assert equals(tanhs(Qs([R])), Qs([Q([0.9950547536867305, 0, 0, 0])]))
    assert equals(
        tanhs(Qs([C])), Qs([Q([1.0046823121902353, 0.0364233692474038, 0, 0])])
    )
...
def test__1560_exp():
    ...
    assert equal(
        exp(P), Q([0.2836621854632263, -0.7671394197305108, 0.5753545647978831, 0])
    )
...
def test__1570_ln():
    ...
    assert equal(
        ln(P), Q([1.6094379124341003, 1.2566370614359172, -0.9424777960769379, 0])
    )
...
def test__1571_lns():
    ...
    assert equals(
        lns(Qs([P])),
        Qs([Q([1.6094379124341003, 1.2566370614359172, -0.9424777960769379, 0])]),
    )
...
def test__1305_bracket():
    bracket1234 = Qs().bracket(q_1234, identity(4, operator=True), q_1234)
